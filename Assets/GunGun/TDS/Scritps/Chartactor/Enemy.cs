...
public class Enemy : Actor
{
    ...
    private void StatsCaculate()
    {
        ...
        float hpUp = m_enemyStats.hpUp * Helper.upGrade(playerStats.level + 1);
    ...
    {
        ItemManager.Ins.spawn(transform.position);
    ...
    private void OnAddXp()
    {
        if (m_player != null)
        { 
            GameManager.Ins.Player.Addexp(xpBonus);
    ...
    private void TryAttack()
    {
        ...
        {
            // m_animation.SetTrigger(AnimationConsts.ENEMY_Atk_PARAM);
